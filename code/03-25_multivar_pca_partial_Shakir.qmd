...
```
There is no significant (p-value = 0.474) negative relationship ["Estimate"  of slope for PC4 in the summary() function was positive = 0.049160] between PC2 and "strength_gtex
